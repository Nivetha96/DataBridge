...
def sftp_connector():
    ...
    with patch("databridge.connectors.sftp_connector.paramiko.Transport") as MockTransport:
        ...
        with patch("databridge.connectors.sftp_connector.paramiko.SFTPClient.from_transport",
